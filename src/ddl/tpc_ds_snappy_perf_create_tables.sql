...
create external table call_center_text_staging
(
...
using row
as (select * from call_center_text_staging)
;
drop table if exists call_center_text_staging;

drop table if exists catalog_page_text_staging;
create external table catalog_page_text_staging
(
...
using row
as (select * from catalog_page_text_staging)
;
drop table if exists catalog_page_text_staging;

drop table if exists catalog_returns_text_staging;
create external table catalog_returns_text_staging
(
...
using column
OPTIONS(PARTITION_BY 'cr_order_number')
as (select * from catalog_returns_text_staging)
;
drop table if exists catalog_returns_text_staging;


drop table if exists catalog_sales_text_staging;
create external table catalog_sales_text_staging
(
    cs_sold_date_sk           int,
    cs_sold_time_sk           int,
    cs_ship_date_sk           int,
...
using column
OPTIONS(PARTITION_BY 'cs_order_number', COLOCATE_WITH 'CATALOG_RETURNS')
as (select * from catalog_sales_text_staging)
;
drop table if exists catalog_sales_text_staging;

drop table if exists customer_text_staging;
create external table customer_text_staging
(
    c_customer_sk             int,
...
using column
OPTIONS(PARTITION_BY 'c_customer_sk')
as (select * from customer_text_staging)
;
drop table if exists customer_text_staging;


drop table if exists customer_address_text_staging;
create external table customer_address_text_staging
(
    ca_address_sk             int,
...
using column
OPTIONS(PARTITION_BY 'ca_address_sk')
as (select * from customer_address_text_staging)
;
drop table if exists customer_address_text_staging;

drop table if exists customer_demographics_text_staging;
create external table customer_demographics_text_staging
(
    cd_demo_sk                int,
    cd_gender                 string,
...
using row
as (select * from customer_demographics_text_staging)
;
drop table if exists customer_demographics_text_staging;

drop table if exists date_dim_text_staging;
create external table date_dim_text_staging
(
    d_date_sk                 int,
    d_date_id                 string,
    d_date                    string,
...
using row
as (select * from date_dim_text_staging)
;
drop table if exists date_dim_text_staging;

drop table if exists household_demographics_text_staging;
create external table household_demographics_text_staging
(
    hd_demo_sk                int,
...
using row
as (select * from household_demographics_text_staging)
;
drop table if exists household_demographics_text_staging;

drop table if exists income_band_text_staging;
create external table income_band_text_staging
(
...
using row
as (select * from income_band_text_staging)
;
drop table if exists income_band_text_staging;

drop table if exists inventory_text_staging;
create external table inventory_text_staging
(
    inv_date_sk               int,
    inv_item_sk               int,
...
using column
OPTIONS(PARTITION_BY 'inv_item_sk')
as (select * from inventory_text_staging)
;
drop table if exists inventory_text_staging;

drop table if exists item_text_staging;
create external table item_text_staging
(
    i_item_sk                 int,
    i_item_id                 string,
...
create table item
using row
as (select * from item_text_staging)
;
drop table if exists item_text_staging;

drop table if exists promotion_text_staging;
create external table promotion_text_staging
(
    p_promo_sk                int,
    p_promo_id                string,
    p_start_date_sk           int,
...
using row
as (select * from promotion_text_staging)
;
drop table if exists promotion_text_staging;

drop table if exists reason_text_staging;
create external table reason_text_staging
(
    r_reason_sk               int,
    r_reason_id               string,
...
create table reason
using row
as (select * from reason_text_staging)
;
drop table if exists reason_text_staging;

drop table if exists ship_mode_text_staging;
create external table ship_mode_text_staging
(
    sm_ship_mode_sk           int,
...
using row
as (select * from ship_mode_text_staging)
;
drop table if exists ship_mode_text_staging;

drop table if exists store_text_staging;
create external table store_text_staging
(
    s_store_sk                int,
    s_store_id                string,
...
create table store
using row
as (select * from store_text_staging)
;
drop table if exists store_text_staging;

drop table if exists store_returns_text_staging;
create external table store_returns_text_staging
(
...
create external table store_sales_text_staging
(
    ss_sold_date_sk           int,
    ss_sold_time_sk           int,
    ss_item_sk                int,
...
using column
OPTIONS(PARTITION_BY 'ss_item_sk', COLOCATE_WITH 'STORE_RETURNS')
as (select * from store_sales_text_staging)
;
drop table if exists store_sales_text_staging;

drop table if exists time_dim_text_staging;
create external table time_dim_text_staging
(
    t_time_sk                 int,
    t_time_id                 string,
    t_time                    int,
...
using row
as (select * from time_dim_text_staging)
;
drop table if exists time_dim_text_staging;

drop table if exists warehouse_text_staging;
create external table warehouse_text_staging
(
    w_warehouse_sk            int,
...
using row
as (select * from warehouse_text_staging)
;
drop table if exists warehouse_text_staging;

drop table if exists web_page_text_staging;
create external table web_page_text_staging
(
    wp_web_page_sk            int,
...
using row
as (select * from web_page_text_staging)
;
drop table if exists web_page_text_staging;

drop table if exists web_returns_text_staging;
create external table web_returns_text_staging
(
...
using column
OPTIONS(PARTITION_BY 'wr_order_number', COLOCATE_WITH 'CATALOG_SALES')
as (select * from web_returns_text_staging)
;
drop table if exists web_returns_text_staging;

drop table if exists web_sales_text_staging;
create external table web_sales_text_staging
(
    ws_sold_date_sk           int,
    ws_sold_time_sk           int,
    ws_ship_date_sk           int,
...
using column
OPTIONS(PARTITION_BY 'ws_order_number', COLOCATE_WITH 'WEB_RETURNS')
as (select * from web_sales_text_staging)
;
drop table if exists web_sales_text_staging;

drop table if exists web_site_text_staging;
create external table web_site_text_staging
(
    web_site_sk               int,
    web_site_id               string,
...
using row
as (select * from web_site_text_staging)
;
drop table if exists web_site_text_staging;
