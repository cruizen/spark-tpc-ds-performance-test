...
create  table call_center_text_staging
(
...
create  table catalog_page_text_staging
(
...
create  table catalog_returns_text_staging
(
...
create  table catalog_sales_text_staging
(
    cs_sold_date_sk           int,
    cs_sold_time_sk           int,
    cs_ship_date_sk           int,
...
create  table customer_text_staging
(
    c_customer_sk             int,
...
create  table customer_address_text_staging
(
    ca_address_sk             int,
...
create  table customer_demographics_text_staging
(
    cd_demo_sk                int,
    cd_gender                 string,
...
create  table date_dim_text_staging
(
    d_date_sk                 int,
    d_date_id                 string,
    d_date                    string,
...
create  table household_demographics_text_staging
(
    hd_demo_sk                int,
...
create  table income_band_text_staging
(
...
create  table inventory_text_staging
(
    inv_date_sk               int,
    inv_item_sk               int,
...
create  table item_text_staging
(
    i_item_sk                 int,
    i_item_id                 string,
...
create  table promotion_text_staging
(
    p_promo_sk                int,
    p_promo_id                string,
    p_start_date_sk           int,
...
create  table reason_text_staging
(
    r_reason_sk               int,
    r_reason_id               string,
...
create  table ship_mode_text_staging
(
    sm_ship_mode_sk           int,
...
create  table store_text_staging
(
    s_store_sk                int,
    s_store_id                string,
...
create  table store_returns_text_staging
(
...
create  table store_sales_text_staging
(
    ss_sold_date_sk           int,
    ss_sold_time_sk           int,
    ss_item_sk                int,
...
create  table time_dim_text_staging
(
    t_time_sk                 int,
    t_time_id                 string,
    t_time                    int,
...
create  table warehouse_text_staging
(
    w_warehouse_sk            int,
...
create  table web_page_text_staging
(
    wp_web_page_sk            int,
...
create  table web_returns_text_staging
(
...
create  table web_sales_text_staging
(
    ws_sold_date_sk           int,
    ws_sold_time_sk           int,
    ws_ship_date_sk           int,
...
create  table web_site_text_staging
(
    web_site_sk               int,
    web_site_id               string,
